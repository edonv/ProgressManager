...
extension ProgressManager {
    ...
    ///   - childTask: The key of a child task to update.
    ...
    /// - Parameters:
    ///   - childTask: The key of a child task to update.
    ///   - updateClosure: A closure, provided with the current count of completed units, that should return an updated current count of completed units.
...
extension ProgressManager {
    ...
    /// - Parameter childTask: The key of a child task from which to get a publisher (if such a child task exists).
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
